...
EDS_SERVER  = "EDS/eds_instance" #This tells Tango which device server process will run the device. <ServerName>/<InstanceName>
EDS_CLASS   = "EDS" #When creating this device, instantiate class HAADF. DB knows device type → HAADF
EDS_DEVICE  = "test/eds/1" #This is the actual device object name clients connect to. Domain/family/member -> test/haadf/1 : DeviceProxy("test/haadf/1")
